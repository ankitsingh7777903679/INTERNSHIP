...
function Dimond() {
    ...
    const hasStoneGroupWritePermission = userPermissions.includes('stoneGroup_write') && (userRole === 'user') || (userRole === 'admin');
    ...
    return (
        <>
            <div className="p-4 grid grid-cols-[40%_auto] gap-7">
                {hasStoneGroupWritePermission && (
                    <div className="">
                        <h1 className="text-2xl text-white font-bold mb-4">Stone Group</h1>
                        {/* <ToastContainer /> */}
